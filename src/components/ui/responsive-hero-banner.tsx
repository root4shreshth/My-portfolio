...
const ResponsiveHeroBanner: React.FC<ResponsiveHeroBannerProps> = ({
  ...
  titleLine2 = "AI Product Engineer",
  description = "AI Product Engineer shipping production-grade AI products powered by LLMs, agentic systems, and real-time voice pipelines. Owns the full 0-to-1 lifecycle across product design, backend engineering, AI integration, and deployment.",
